...
class BaseAPIRequestLog(models.Model):
    ...
    username_persistent = models.CharField(
        max_length=getattr(settings, "DRF_TRACKING_USERNAME_LENGTH", 128),
        null=True,
        blank=True,
    )
    ...
    path = models.CharField(
        max_length=getattr(settings, "DRF_TRACKING_PATH_LENGTH", 256),
        db_index=True,
        help_text="url path",
    )
    view = models.CharField(
        max_length=getattr(settings, "DRF_TRACKING_VIEW_LENGTH", 256),
        null=True,
        blank=True,
        db_index=True,
    ...
    view_method = models.CharField(
        max_length=getattr(settings, "DRF_TRACKING_VIEW_METHOD_LENGTH", 256),
        null=True,
        blank=True,
        db_index=True,
    )
