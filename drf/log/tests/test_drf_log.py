...
class TestLoggingMixinHandleLog(SimpleTestCase):
    ...
    def test_handle_log_saves_log(self, mock_model, _mock_should_log):
    ...
    @patch("qux.drf.log.mixins.should_log", return_value=True)
    @patch("qux.drf.log.mixins.APIRequestLog")
    def test_handle_log_pops_oversized_fields(self, mock_model, _mock_should_log):
...
class TestAdminReadonlyFields(SimpleTestCase):
    ...
    def test_readonly_fields_set_when_setting_enabled(self):
        ...
        from qux.drf.log.models import APIRequestLog, APILoggingRule
