...
from qux.contacts.models import AbstractContactEmail, AbstractContactPhone
from qux.models.audit import CoreModelAuditDetails, CoreModelAuditSummary
from qux.models.base import AbstractLead, CoreModel, default_null_blank
from qux.models.contacts import AbstractCompany, AbstractProfile
from qux.models.plus import CoreModelPlus
from qux.utils.modelfields import FloatListField
...
class RandomItem(CoreModel):
    ...
    decimal_field_required = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    date_field_required = models.DateField(default="2000-01-01")
    datetime_field_required = models.DateTimeField(auto_now=False, default="2000-01-01T00:00:00Z")
...
class AuditedItem(CoreModel):
    ...
    name = models.CharField(max_length=64)
    user = models.ForeignKey(get_user_model(), on_delete=models.SET_NULL, **default_null_blank)
