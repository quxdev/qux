...
class SEOPage(SEOModel):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["site", "canonical"], name="unique_site_canonical"),
        ]
...
class SEOAudit(QuxModel):
    ...
    status = models.CharField(max_length=16, choices=AUDIT_STATUS_CHOICES, default="pending")
...
class SEOAuditURL(QuxModel):
    ...
    audit = models.ForeignKey(SEOAudit, on_delete=models.CASCADE, related_name="results")
