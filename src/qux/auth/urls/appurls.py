...
# magic-link/ is registered unconditionally so reverse() and {% url %} resolve
# in every project. MagicLinkRequestView.dispatch() returns 404 when
# settings.USE_MAGIC_LINK is falsy.
urlpatterns = [
