...
Usage:
    python manage.py pagespeed_report                  # writes to stdout
    python manage.py pagespeed_report --detailed       # include per-file findings
    python manage.py pagespeed_report -o report.txt    # writes to file
"""
